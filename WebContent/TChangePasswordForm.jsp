<%-- 
    Document   : TChangePasswordForm
    Created on : 2019-7-19, 16:04:38
    Author     : X
--%>
...
<form name="ChangePasswordForm" method="post" action="TProcessChangePWD.jsp" OnSubmit="return fncSubmit();">
