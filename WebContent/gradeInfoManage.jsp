	 ...
	 pagination="true" rownumbers="true" url="gradeList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="id" width="50">班级编号</th>
                                <th field="No" width="50">课程编码</th>
				<th field="gradeName" width="100">班级名称</th>
				<th field="gradeTeacher" width="250">代课老师</th>
                                <th field="gradeIP" width="250">IP地址</th>
			</tr>
		</thead>
	</table>
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px;height: 280px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table>
				<tr>
					<td>课程编码：</td>
					<td><input type="text" name="No" id="No" class="easyui-validatebox" required="true"/></td>
				</tr>
                                 <tr>
					<td>班级名称：</td>
				...
				<tr>
					<td>代课老师：</td>
                                        <td><input type="text" name="gradeTeacher" id="gradeTeacher" class="easyui-validatebox" required="true"/></td>
				</tr>
                                <tr>
					<td>IP地址：</td>
                                        <td><input type="text" name="gradeIP" id="gradeIP" class="easyui-validatebox" required="true"/></td>
				</tr>
			</table>
		</form>
	</div>
