<%-- 
    Document   : teacherqiandao
    Created on : 2019-7-19, 15:20:43
    Author     : gyt
--%>
...
<html>
    ...
    <body style="text-align: center">
        ...
        <form action="ShowqdServlet" method="post" name="form">
            <table width="740" height="500" background="images/result.jpg">
                <tr height="130">
				<td colspan="4"></td>
			</tr>
                <tr height="10">
