...
<script type="text/javascript">
    ...
    $(function(){
		...
		var treeData=[{
				...
				text:"签到",
				attributes:{
					url:"qiandao.jsp?ID=<%= ID %>"
				}
			},{
				text:"作业提交",
				attributes:{
					url:"showzy.jsp?ID=<%= ID%>"
				}
			},{
				text:"成绩查看",
				attributes:{
					url:"ShowcjServlet?ID=<%= ID %>"
				}
			}];
...
<body class="easyui-layout">
	...
	<div region="west" style="width: 150px;" title="学生用户" split="true">
		<ul id="tree"></ul>
	</div>
