...
public class GradeSaveServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String gradeTeacher=request.getParameter("gradeTeacher");
		String No=request.getParameter("No");
                String id=request.getParameter("id");
                String gradeIP=request.getParameter("gradeIP");
		Grade grade=new Grade(No,gradeName,gradeTeacher,gradeIP);
